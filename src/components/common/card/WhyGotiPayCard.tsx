...
const WhyGotiPayCard: React.FC<WhyGotiPayCardProps> = ({
    ...
    return (
        <motion.div
            ...
            className="relative group flex items-center sm:items-start sm:flex-row flex-col gap-6 p-3 md:p-6 rounded-lg cursor-pointer
        ...
        >
            ...
            <span className="absolute -top-1/2 left-1/4 w-2/3 h-[200%] 
