  ...
  return (
    <>
      <nav className="w-full bg-white border-b border-gray-200  px-6 py-3 flex justify-between items-center sticky top-0 z-50">
        <div className="text-xl font-bold"><div className="flex items-center text-[var(--primary)] text-2xl"><Link href={'/'}><Image src='/logo.svg' alt='' width={140} height={32} /> </Link>API</div></div>
