    ...
    <AnimatePresence>
      {scroll.scrolled && (
        <motion.button
          ...
          className="fixed bottom-5 right-5 w-14 h-14 flex items-center justify-center rounded-full bg-purple-700 text-white shadow-lg hover:bg-purple-800 z-50 cursor-pointer"
